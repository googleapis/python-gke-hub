...
from google.cloud.gkehub_v1alpha.services.gke_hub.transports.base import (
...
def test_gke_hub_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_gke_hub_base_transport():
    ...
    with mock.patch(
        "google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubTransport.__init__"
    ) as Transport:
...
def test_gke_hub_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.gkehub_v1alpha.services.gke_hub.transports.GkeHubTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
