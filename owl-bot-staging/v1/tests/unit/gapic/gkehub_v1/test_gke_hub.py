...
@pytest.mark.parametrize("client_class", [
    GkeHubClient, GkeHubAsyncClient
])
@mock.patch.object(GkeHubClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GkeHubClient))
@mock.patch.object(GkeHubAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GkeHubAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (GkeHubAsyncClient, transports.GkeHubGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_create_membership_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_membership(
            parent='parent_value',
            resource=membership.Membership(endpoint=membership.MembershipEndpoint(gke_cluster=membership.GkeCluster(resource_link='resource_link_value'))),
...
def test_list_memberships_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GkeHubRestInterceptor, "post_list_memberships") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_list_memberships") as pre:
...
def test_list_features_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_list_features") as post, \
...
def test_get_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_get_membership") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_get_membership") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GkeHubRestInterceptor, "post_create_membership") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_create_membership") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_create_feature") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_create_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_delete_membership") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_delete_membership") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_delete_feature") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_delete_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_membership_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_update_membership") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_update_membership") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_update_feature") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_update_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_connect_manifest_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GkeHubRestInterceptor, "post_generate_connect_manifest") as post, \
         mock.patch.object(transports.GkeHubRestInterceptor, "pre_generate_connect_manifest") as pre:
        pre.assert_not_called()
        post.assert_not_called()
