...
def test_gke_hub_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_list_memberships(transport: str = 'grpc', request_type=service.ListMembershipsRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_membership(transport: str = 'grpc', request_type=service.GetMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_membership(transport: str = 'grpc', request_type=service.CreateMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_membership(transport: str = 'grpc', request_type=service.UpdateMembershipRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_generate_connect_manifest(transport: str = 'grpc', request_type=service.GenerateConnectManifestRequest):
    client = GkeHubClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
