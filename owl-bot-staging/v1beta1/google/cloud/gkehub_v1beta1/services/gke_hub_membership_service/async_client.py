...
class GkeHubMembershipServiceAsyncClient:
    ...
    **Membership management may be non-trivial:** it is recommended to
    ...
    async def generate_connect_manifest(self,
            request: Optional[Union[membership.GenerateConnectManifestRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    async def validate_exclusivity(self,
    ...
    async def generate_exclusivity_manifest(self,
            request: Optional[Union[membership.GenerateExclusivityManifestRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, str]] = (),
