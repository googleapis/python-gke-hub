...
class Membership(proto.Message):
    ...
    endpoint = proto.Field(proto.MESSAGE, number=4, oneof='type',
        message='MembershipEndpoint',
    )

    state = proto.Field(proto.MESSAGE, number=5,
        message='MembershipState',
    )

    authority = proto.Field(proto.MESSAGE, number=9,
        message='Authority',
    )
    ...
    last_connection_time = proto.Field(proto.MESSAGE, number=11,
        message=timestamp.Timestamp,
    )

    unique_id = proto.Field(proto.STRING, number=12)

    infrastructure_type = proto.Field(proto.ENUM, number=13,
...
class MembershipEndpoint(proto.Message):
    ...
    gke_cluster = proto.Field(proto.MESSAGE, number=4,
        message='GkeCluster',
    )

    kubernetes_metadata = proto.Field(proto.MESSAGE, number=5,
        message='KubernetesMetadata',
    )

    kubernetes_resource = proto.Field(proto.MESSAGE, number=6,
...
class KubernetesResource(proto.Message):
    ...
    membership_resources = proto.RepeatedField(proto.MESSAGE, number=2,
        message='ResourceManifest',
    )

    connect_resources = proto.RepeatedField(proto.MESSAGE, number=3,
        message='ResourceManifest',
    )

    resource_options = proto.Field(proto.MESSAGE, number=4,
...
class KubernetesMetadata(proto.Message):
    ...
    update_time = proto.Field(proto.MESSAGE, number=100,
        message=timestamp.Timestamp,
    )
...
class GenerateConnectManifestRequest(proto.Message):
    ...
    connect_agent = proto.Field(proto.MESSAGE, number=2,
...
class GenerateConnectManifestResponse(proto.Message):
    ...
    manifest = proto.RepeatedField(proto.MESSAGE, number=1,
...
class ConnectAgentResource(proto.Message):
    ...
    type_ = proto.Field(proto.MESSAGE, number=1,
        message='TypeMeta',
    )
