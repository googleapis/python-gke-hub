...
class Membership(proto.Message):
    ...
    authority = proto.Field(proto.MESSAGE, number=10, message="Authority",)
...
class KubernetesResource(proto.Message):
    ...
    connect_resources = proto.RepeatedField(
        proto.MESSAGE, number=4, message="ResourceManifest",
    )
    resource_options = proto.Field(proto.MESSAGE, number=5, message="ResourceOptions",)
...
class Authority(proto.Message):
    ...
    oidc_jwks = proto.Field(proto.BYTES, number=5,)
    identity_provider = proto.Field(proto.STRING, number=3,)
    workload_identity_pool = proto.Field(proto.STRING, number=4,)
...
class InitializeHubResponse(proto.Message):
    ...
    service_identity = proto.Field(proto.STRING, number=1,)
