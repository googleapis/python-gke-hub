...
class MembershipState(proto.Message):
    ...
    Attributes:
        cluster_name (str):
            ...
            installation.
        membership_spec (google.cloud.gkehub.configmanagement_v1beta.types.MembershipSpec):
        ...
        operator_state (google.cloud.gkehub.configmanagement_v1beta.types.OperatorState):
            Current install status of ACM's Operator
        config_sync_state (google.cloud.gkehub.configmanagement_v1beta.types.ConfigSyncState):
            Current sync status
        policy_controller_state (google.cloud.gkehub.configmanagement_v1beta.types.PolicyControllerState):
            PolicyController status
        binauthz_state (google.cloud.gkehub.configmanagement_v1beta.types.BinauthzState):
            Binauthz status
        hierarchy_controller_state (google.cloud.gkehub.configmanagement_v1beta.types.HierarchyControllerState):
    ...
    binauthz_state = proto.Field(proto.MESSAGE, number=6, message="BinauthzState",)
...
class MembershipSpec(proto.Message):
    ...
    Attributes:
        config_sync (google.cloud.gkehub.configmanagement_v1beta.types.ConfigSync):
            Config Sync configuration for the cluster.
        policy_controller (google.cloud.gkehub.configmanagement_v1beta.types.PolicyController):
            Policy Controller configuration for the
            cluster.
        binauthz (google.cloud.gkehub.configmanagement_v1beta.types.BinauthzConfig):
            Binauthz conifguration for the cluster.
        hierarchy_controller (google.cloud.gkehub.configmanagement_v1beta.types.HierarchyControllerConfig):
    ...
    binauthz = proto.Field(proto.MESSAGE, number=3, message="BinauthzConfig",)
...
class ConfigSync(proto.Message):
    ...
    Attributes:
        git (google.cloud.gkehub.configmanagement_v1beta.types.GitConfig):
...
class HierarchyControllerDeploymentState(proto.Message):
    ...
    Attributes:
        hnc (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            The deployment state for open source HNC
            (e.g. v0.7.0-hc.0)
        extension (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
...
class HierarchyControllerState(proto.Message):
    ...
    Attributes:
        version (google.cloud.gkehub.configmanagement_v1beta.types.HierarchyControllerVersion):
            The version for Hierarchy Controller
        state (google.cloud.gkehub.configmanagement_v1beta.types.HierarchyControllerDeploymentState):
            The deployment state for Hierarchy Controller
    """
...
class OperatorState(proto.Message):
    ...
    Attributes:
        ...
        deployment_state (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            The state of the Operator's deployment
        errors (Sequence[google.cloud.gkehub.configmanagement_v1beta.types.InstallError]):
            Install errors.
    """
...
class ConfigSyncState(proto.Message):
    ...
    Attributes:
        version (google.cloud.gkehub.configmanagement_v1beta.types.ConfigSyncVersion):
            The version of ConfigSync deployed
        deployment_state (google.cloud.gkehub.configmanagement_v1beta.types.ConfigSyncDeploymentState):
            Information about the deployment of
            ConfigSync, including the version of the various
            Pods deployed
        sync_state (google.cloud.gkehub.configmanagement_v1beta.types.SyncState):
...
class ConfigSyncDeploymentState(proto.Message):
    ...
    Attributes:
        importer (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            Deployment state of the importer pod
        syncer (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            Deployment state of the syncer pod
        git_sync (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            Deployment state of the git-sync pod
        monitor (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            Deployment state of the monitor pod
        reconciler_manager (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            Deployment state of reconciler-manager pod
        root_reconciler (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
...
class SyncState(proto.Message):
    ...
    Attributes:
        ...
        last_sync_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            synced the repo
        code (google.cloud.gkehub.configmanagement_v1beta.types.SyncState.SyncCode):
            Sync status code
        errors (Sequence[google.cloud.gkehub.configmanagement_v1beta.types.SyncError]):
...
class SyncError(proto.Message):
    ...
    Attributes:
        ...
        error_resources (Sequence[google.cloud.gkehub.configmanagement_v1beta.types.ErrorResource]):
...
class ErrorResource(proto.Message):
    ...
    Attributes:
        ...
        resource_namespace (str):
            ...
            error
        resource_gvk (google.cloud.gkehub.configmanagement_v1beta.types.GroupVersionKind):
...
class PolicyControllerState(proto.Message):
    ...
    Attributes:
        version (google.cloud.gkehub.configmanagement_v1beta.types.PolicyControllerVersion):
            The version of Gatekeeper Policy Controller
            deployed.
        deployment_state (google.cloud.gkehub.configmanagement_v1beta.types.GatekeeperDeploymentState):
...
class BinauthzState(proto.Message):
    ...
    Attributes:
        webhook (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            The state of the binauthz webhook.
        version (google.cloud.gkehub.configmanagement_v1beta.types.BinauthzVersion):
            The version of binauthz that is installed.
    """

    webhook = proto.Field(proto.ENUM, number=1, enum="DeploymentState",)
    version = proto.Field(proto.MESSAGE, number=2, message="BinauthzVersion",)
...
class BinauthzVersion(proto.Message):
    ...
    webhook_version = proto.Field(proto.STRING, number=1,)


class GatekeeperDeploymentState(proto.Message):
    r"""State of Policy Controller installation.
    Attributes:
        gatekeeper_controller_manager_state (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
            Status of gatekeeper-controller-manager pod.
        gatekeeper_audit (google.cloud.gkehub.configmanagement_v1beta.types.DeploymentState):
