...
class MembershipState(proto.Message):
    ...
    Attributes:
        cluster_name (str):
            ...
            installation.
        membership_spec (google.cloud.gkehub.configmanagement_v1alpha.types.MembershipSpec):
        ...
        operator_state (google.cloud.gkehub.configmanagement_v1alpha.types.OperatorState):
            Current install status of ACM's Operator
        config_sync_state (google.cloud.gkehub.configmanagement_v1alpha.types.ConfigSyncState):
            Current sync status
        policy_controller_state (google.cloud.gkehub.configmanagement_v1alpha.types.PolicyControllerState):
            PolicyController status
        binauthz_state (google.cloud.gkehub.configmanagement_v1alpha.types.BinauthzState):
            Binauthz status
        hierarchy_controller_state (google.cloud.gkehub.configmanagement_v1alpha.types.HierarchyControllerState):
...
class MembershipSpec(proto.Message):
    ...
    Attributes:
        config_sync (google.cloud.gkehub.configmanagement_v1alpha.types.ConfigSync):
            Config Sync configuration for the cluster.
        policy_controller (google.cloud.gkehub.configmanagement_v1alpha.types.PolicyController):
            Policy Controller configuration for the
            cluster.
        binauthz (google.cloud.gkehub.configmanagement_v1alpha.types.BinauthzConfig):
            Binauthz conifguration for the cluster.
        hierarchy_controller (google.cloud.gkehub.configmanagement_v1alpha.types.HierarchyControllerConfig):
...
class PolicyController(proto.Message):
    ...
    Attributes:
        ...
        mutation_enabled (bool):
            Enable users to try out mutation for
            PolicyController.
    """
    ...
    mutation_enabled = proto.Field(proto.BOOL, number=7,)
...
class HierarchyControllerDeploymentState(proto.Message):
    ...
    Attributes:
        hnc (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            ...
            (e.g. v0.7.0-hc.0)
        extension (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
...
class HierarchyControllerState(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.gkehub.configmanagement_v1alpha.types.HierarchyControllerDeploymentState):
            The deployment state for Hierarchy Controller
    """
...
class OperatorState(proto.Message):
    ...
    Attributes:
        ...
        deployment_state (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            The state of the Operator's deployment
        errors (Sequence[google.cloud.gkehub.configmanagement_v1alpha.types.InstallError]):
            Install errors.
    """
...
class ConfigSyncState(proto.Message):
    ...
    Attributes:
        ...
        deployment_state (google.cloud.gkehub.configmanagement_v1alpha.types.ConfigSyncDeploymentState):
            Information about the deployment of
            ConfigSync, including the version of the various
            Pods deployed
        sync_state (google.cloud.gkehub.configmanagement_v1alpha.types.SyncState):
...
class ConfigSyncDeploymentState(proto.Message):
    ...
    Attributes:
        ...
        syncer (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            Deployment state of the syncer pod
        git_sync (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            Deployment state of the git-sync pod
        monitor (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            Deployment state of the monitor pod
        reconciler_manager (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            Deployment state of reconciler-manager pod
        root_reconciler (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
...
class SyncState(proto.Message):
    ...
    Attributes:
        ...
        last_sync_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            synced the repo
        code (google.cloud.gkehub.configmanagement_v1alpha.types.SyncState.SyncCode):
            Sync status code
        errors (Sequence[google.cloud.gkehub.configmanagement_v1alpha.types.SyncError]):
...
class SyncError(proto.Message):
    ...
    Attributes:
        ...
        error_resources (Sequence[google.cloud.gkehub.configmanagement_v1alpha.types.ErrorResource]):
...
class ErrorResource(proto.Message):
    ...
    Attributes:
        ...
        resource_namespace (str):
            ...
            error
        resource_gvk (google.cloud.gkehub.configmanagement_v1alpha.types.GroupVersionKind):
...
class PolicyControllerState(proto.Message):
    ...
    Attributes:
        version (google.cloud.gkehub.configmanagement_v1alpha.types.PolicyControllerVersion):
            ...
            deployed.
        deployment_state (google.cloud.gkehub.configmanagement_v1alpha.types.GatekeeperDeploymentState):
...
class BinauthzState(proto.Message):
    ...
    Attributes:
        ...
        version (google.cloud.gkehub.configmanagement_v1alpha.types.BinauthzVersion):
...
class GatekeeperDeploymentState(proto.Message):
    ...
    Attributes:
        ...
        gatekeeper_audit (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            Status of gatekeeper-audit deployment.
        gatekeeper_mutation (google.cloud.gkehub.configmanagement_v1alpha.types.DeploymentState):
            Status of the pod serving the mutation
            webhook.
    """
    ...
    gatekeeper_mutation = proto.Field(proto.ENUM, number=3, enum="DeploymentState",)
