...
class FeatureState(proto.Message):
    ...
    analysis_messages = proto.RepeatedField(
        proto.MESSAGE, number=1, message="AnalysisMessage",
    )
...
class AnalysisMessageBase(proto.Message):
    ...
    type_ = proto.Field(proto.MESSAGE, number=1, message=Type,)
    level = proto.Field(proto.ENUM, number=2, enum=Level,)
    documentation_url = proto.Field(proto.STRING, number=3,)
...
class AnalysisMessage(proto.Message):
    ...
    message_base = proto.Field(proto.MESSAGE, number=1, message="AnalysisMessageBase",)
    description = proto.Field(proto.STRING, number=2,)
    resource_paths = proto.RepeatedField(proto.STRING, number=3,)
    args = proto.Field(proto.MESSAGE, number=4, message=struct_pb2.Struct,)
