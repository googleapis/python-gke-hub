...
__protobuf__ = proto.module(
    ...
    manifest={"Billing", "FeatureSpec",},
)


class Billing(proto.Enum):
    r"""Billing identifies which billing structure the customer is
    using.
    """
...
class FeatureSpec(proto.Message):
    ...
    Attributes:
        ...
        billing (google.cloud.gkehub.multiclusteringress_v1alpha.types.Billing):
            Customer's billing structure
    """

    config_membership = proto.Field(proto.STRING, number=1,)
    billing = proto.Field(proto.ENUM, number=2, enum="Billing",)
